...
restaurante1:Restaurant = Restaurant("Papillon", "Braceria")
restaurante1.describe_restaurant()

restaurante2:Restaurant = Restaurant("La Pinseria", "Pizzeria")
restaurante2.describe_restaurant()

restaurante3:Restaurant = Restaurant("Pasqualotto", "Gelatteria")
